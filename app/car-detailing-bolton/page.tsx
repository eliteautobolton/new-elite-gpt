        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-20 pt-10 md:px-8 md:pb-28 md:pt-20">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/68">
              Premium car detailing for customers in Bolton and surrounding areas. Choose a custom detail, machine polish, ceramic protection or regular maintenance plan with Elite Auto Detailing.
            </p>
