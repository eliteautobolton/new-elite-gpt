    ...
    <main className="min-h-screen bg-[#05070d] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <header className="relative mx-auto flex max-w-7xl items-center justify-between px-5 py-5 md:px-8">
          <Link href="/" className="flex items-center gap-3"><img src="/logo.png" alt="Elite Auto Detailing logo" className="h-14 w-14 rounded-2xl object-contain" /><div><p className="text-lg font-semibold tracking-tight">Elite Auto Detailing</p><p className="text-xs text-white/55">Maintenance Program</p></div></Link>
